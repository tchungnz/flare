...
extension FlareViewController: CLLocationManagerDelegate {
    ...
    func save30FlaresToDatabase() {
        ...
        while i <= 29 {
            ...
            let flare1 = ["facebookID": "x", "title": "fake flare", "subtitle": "Flare HQ", "imageRef": "test image", "latitude": latitudeArray[i] as String, "longitude": longitudeArray[i] as String, "timestamp": timestamp, "isPublic": true as Bool] as [String : Any]
